...
${OBJECTDIR}/_ext/1782925000/StringTokenizer.o: ../openmapcad/src/StringTokenizer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1782925000/StringTokenizer.o ../openmapcad/src/StringTokenizer.cpp
