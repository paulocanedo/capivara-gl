...
${OBJECTDIR}/Label.o: Label.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Label.o Label.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
...
${OBJECTDIR}/Button.o: Button.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Button.o Button.cpp

${OBJECTDIR}/RadioButton.o: RadioButton.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/RadioButton.o RadioButton.cpp

${OBJECTDIR}/GroupButtonControl.o: GroupButtonControl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/GroupButtonControl.o GroupButtonControl.cpp

${OBJECTDIR}/RootContainer.o: RootContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/RootContainer.o RootContainer.cpp

${OBJECTDIR}/FontManager.o: FontManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/FontManager.o FontManager.cpp

${OBJECTDIR}/Graphics.o: Graphics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Graphics.o Graphics.cpp

${OBJECTDIR}/Font.o: Font.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Font.o Font.cpp

${OBJECTDIR}/Image.o: Image.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/freetype2 -I/usr/include/FTGL -I/usr/include/GL `pkg-config --cflags freetype2` `pkg-config --cflags ftgl` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Image.o Image.cpp
